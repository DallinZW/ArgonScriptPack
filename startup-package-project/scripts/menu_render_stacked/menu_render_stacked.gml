	...
	for(var i = 0; i < w; i++)
	{
		...
		if(!(i == select_index))
		{
			...
			if(is_string(menu_array[i][MENUDATA.SCRIPT]))
			{
				...
				draw_text(x + sprite_get_width(menu_arrows[0]) * 2 + menu_array[i][MENUDATA.MAX_VALUE_WIDTH]/2, y + h, value)
				...
				draw_sprite_ext(menu_arrows[0], 0, x, y + h, 1, 1, 0, c_white, arrowalpha)
				...
				draw_sprite_ext(menu_arrows[1], 0, x + sprite_get_width(menu_arrows[1]) * 2 + sprite_get_width(menu_arrows[0]) * 2 + menu_array[i][MENUDATA.MAX_VALUE_WIDTH], y + h, 1, 1, 0, c_white, arrowalpha)
		...
		else
		{
			...
			if(is_string(menu_array[i][MENUDATA.SCRIPT]))
			{
				...
				draw_sprite_ext(menu_arrows[0], 0, x + (xoff * (menu_bump_dir_x == -1)), y + h, 1, 1, 0, c_white, arrowalpha)
				...
				draw_sprite_ext(menu_arrows[1], 0, x + sprite_get_width(menu_arrows[1]) * 2 + sprite_get_width(menu_arrows[0]) * 2 + menu_array[i][MENUDATA.MAX_VALUE_WIDTH] + (xoff * (menu_bump_dir_x == 1)), y + h, 1, 1, 0, c_white, arrowalpha)
